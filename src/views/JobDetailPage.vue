      ...
      <div class="modal-content-ats" @click.stop>
        ...
        <div class="d-flex gap-2 ms-4 ">
          <div class="btn-group" role="group">
            <input type="radio" class="btn-check" id="videoCall" :value="1" v-model="assignmentData.isVideoCall" />
            <label class="btn btn-outline-success" for="videoCall">Video Call</label>
            <input type="radio" class="btn-check" id="audioCall" :value="0" v-model="assignmentData.isVideoCall" />
            <label class="btn btn-outline-danger" for="audioCall">Audio Call</label>
            <input type="radio" class="btn-check" id="faceToFace" :value="2" v-model="assignmentData.isVideoCall" />
            <label class="btn btn-outline-danger" for="faceToFace">Face to face</label>
          </div>
        ...
        <div v-if="!assignMultipleInterviwer" class="modal-body-ats">
          <form @submit.prevent="assignInterviewer">
            <div class="form-group">
              ...
              <select v-model="assignmentData.interviewer_id" @change="fetchAvailableSlots" required
          ...
          <form @submit.prevent="assignInterviewerGroup">
            ...
            <div class="form-group">
              ...
              <select v-model="selectedInterviewersforAssign" multiple class="form-select-ats"
                @change="fetchAvailableSlotsByGroup" style="min-height: 120px;">
                <option value="">Select Interviewer</option>
                <option v-for="interviewer in assignInterviewers" :key="interviewer.id" :value="interviewer.id">
                  {{ interviewer.full_name || interviewer.email }}
                </option>
